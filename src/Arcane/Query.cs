...
namespace Arcane
{
    ...
    public abstract class Query<T> : ArcaneQueryable<T>, IQuery<T>
    {
        ...
        {
            StoreFactory = context.StoreFactory;
        }
        ...
        /// 
        /// </summary>
        public IDataStoreFactory StoreFactory { get; set; }
        ...
        /// <summary>
        /// Returns an interface that will synchronize entities of <typeparamref name="T"/> with a backing store.
        /// </summary>
        /// <returns>Returns an interface that will synchronize entities of <typeparamref name="T"/> with a backing store.</returns>
